...
groceries = []
with open("C:\\Users\\suraj baraik\\Desktop\\Data Science\\Suraj\\New folder (12)\\Module 15 Data Mining Unsupervised Learning - Association Rule\\groceries.csv") as f:
    groceries = f.read()
...
plt.bar(items, height = frequencies[1:11], left = list(range(1,11)),color='rgbkymc');plt.xticks(list(range(1,11),),items[1:11]);plt.xlabel("items")
